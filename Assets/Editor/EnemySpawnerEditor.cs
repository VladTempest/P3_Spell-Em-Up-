...
[CustomEditor( typeof(EnemySpawner) )]
    ...
    public class EnemySpawnerEditor : UnityEditor.Editor
    {
        ...
        {  
            //сокрытие/показ полей для Enum SpawnersFormType 
            ShowOnEnum("spawnersFormType","CirclePerimeter","spawnRadius");
            ShowOnEnum("spawnersFormType","SquarePerimeter","spawnHeight");
            ShowOnEnum("spawnersFormType","SquarePerimeter","spawnWidth");
            
            ShowOnEnum("spawnersCycleType","Finite","numberOfCycles");
            
            ShowOnEnum("spawnersTriggerType","Button","keyCodeForSpawn");
            ShowOnEnum("spawnersTriggerType","TriggerCollider","triggerCollider");
            ShowOnEnum("spawnersTriggerType", "TriggerCollider", "isTriggerColliderReActivatable");
            ShowOnEnum("spawnersTriggerType","Timer","pauseBeforeSpawn");
            
            //ShowOnEnum("spawnersFormType","SquareVolume","spawnHeight");
            //ShowOnEnum("spawnersFormType","SquareVolume","spawnLength");
