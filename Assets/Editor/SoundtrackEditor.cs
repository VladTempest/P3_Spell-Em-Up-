...
[CustomEditor( typeof(Soundtrack) )]
    ...
    public class SoundtrackEditor : UnityEditor.Editor
    {
        ...
        {  
            ...
            ShowOnEnum("typeOfSoundtrack","OST","typeOfOstByItsNature");
            ShowOnEnum("typeOfSoundtrack","SFX","typeOfSfxByItsNature");
            ShowOnEnum("typeOfSoundtrack","SFX","typeOfSfxByNumberOfSounds");
            ShowOnEnum("typeOfSoundtrack","SFX","typeOfSfxByPlace");
